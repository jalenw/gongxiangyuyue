...
#define kTouchToRecord @"长按录音"//NSLocalizedString(@"message.toolBar.record.touch", @"hold down to talk")
#define kTouchToFinish @"松开发送"//NSLocalizedString(@"message.toolBar.record.send", @"loosen to send")
