...
@protocol JPVideoPlayerControlBarDelegate<NSObject>
...
//zyf
@property(nonatomic,strong)id<JPVideoPlayerControlBarDelegate> delegate;
...
@property(nonatomic,strong)id<JPVideoPlayerControlViewDelegate> delegate;
